...
public class VoidAttachmentScreen extends BaseScreen<VoidAttachmentContainerMenu> {
    ...
    public VoidAttachmentScreen(VoidAttachmentContainerMenu container, Inventory inv, Component title) {
    ...
    // 26.1.2: Screen.render() and renderTooltip() removed — the framework now drives
    // extractBackground / extractContents / extractTooltip for us.
    ...
    public void extractBackground(@NotNull GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        // All 15 filter slots are always available for void attachment
        // No need to hide any slots
